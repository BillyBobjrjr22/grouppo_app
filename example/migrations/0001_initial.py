# Generated by Django 5.0.1 on 2024-02-17 02:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='example.topic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='example.room')),
            ],
            options={
                'ordering': ['-updated', '-created'],
            },
        ...
        migrations.AddField(
            model_name='room',
            name='schedules',
            field=models.ManyToManyField(blank=True, to='example.userschedule'),
        ),
    ]
